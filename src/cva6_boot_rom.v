...
module cva6_boot_rom (
    ...
    // ========================================================================
    // ROM Initialization - DISABLED (testbench loads program instead)
    // ========================================================================
    integer i;
    initial begin
        // Initialize all locations to NOP (addi x0, x0, 0)
        // Testbench will override with actual program
        for (i = 0; i < 256; i = i + 1) begin
            rom[i] = 32'h00000013;  // NOP
        end
        
        // COMMENTED OUT - LED Blink Program (RISC-V machine code)
        // Testbench now loads custom programs into ROM
