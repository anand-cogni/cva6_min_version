...
HD_PWD='/home/smita/cva6_min_version/fpga/vivado_project/cva6_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cva6_minimal_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cva6_minimal_top.tcl -notrace
